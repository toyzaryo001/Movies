...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- Movies Grid -->
        <div class="col-md-10">
            <h3>หนังพากย์ไทยทั้งหมด</h3>
            <div class="row">
                <?php 
                // การตั้งค่าหนังพากย์ไทยทั้งหมด
                $limit = 30;
                ...
                if (!empty($search)) {
                    ...
                    // สร้างคำสั่ง SQL สำหรับหนังพากย์ไทย
                    $query = mysqli_query($con, "SELECT * FROM data_movie WHERE sound LIKE '%พากย์ไทย%' AND category = 'movie' ORDER BY id DESC LIMIT $limit OFFSET $offset");
                ...
                while ($result = mysqli_fetch_array($query)) {
                    ...
                    // กำหนดป้ายกำกับพากย์ไทย
                    $dubbedLabel = '<span class="label-dubbed">'.$result['sound'].'</span>';
                    $subbedLabel = '';
                    ...
                    echo '<div class="col-md-2 mb-4"> <!-- Changed col-md-3 to col-md-2 to fit 6 movies -->
